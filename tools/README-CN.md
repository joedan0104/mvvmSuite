...
```
-keep class net.hmzs.tools.** { *; }
-keepclassmembers class net.hmzs.tools.** { *; }
-dontwarn net.hmzs.tools.**
```
...
inputStream2Bitmap, bitmap2InputStream  : inputStream 与 bitmap 互转
outputStream2Bitmap, bitmap2OutputStream: outputStream 与 bitmap 互转
