...
public final class PhoneUtils {
    ...
    public static boolean isPhone() {
        TelephonyManager tm =
                (TelephonyManager) ContextHolder.getContext().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static void sendSms(Context context, final String phoneNumber, final String content) {
        context.startActivity(IntentUtils.getSendSmsIntent(phoneNumber, content, true));
    }
    ...
    public static void sendSmsSilent(final String phoneNumber, final String content) {
        ...
        PendingIntent sentIntent = PendingIntent.getBroadcast(ContextHolder.getContext(), 0, new Intent(), 0);
