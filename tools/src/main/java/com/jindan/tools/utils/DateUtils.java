...
public class DateUtils {
    ...
    public static String formatter(Format format, Object date) {
        if (date == null) {
            ...
            return sdf.format(new Date(StringUtils.getLong(date.toString())));
        }
    }
    ...
    public static String getTimeLeft(Object time) {
        if (time == null) {
            ...
            long diffValue = StringUtils.getLong(time.toString());
     ...
     * @return
     */
    public static String getShortDay(Object time) {
        if (time == null) {
            return "";
        } else {
            SimpleDateFormat sdf = new SimpleDateFormat("MM/dd", Locale.getDefault());
            return sdf.format(new Date(StringUtils.getLong(time.toString())));
        }
    }
