...
public final class ScreenUtils {
    ...
    public static int getScreenWidth() {
        ...
        if (wm == null) {
            return ContextHolder.getResource().getDisplayMetrics().widthPixels;
        }
    ...
    public static int getScreenHeight() {
        WindowManager wm = (WindowManager) ContextHolder.getContext().getSystemService(Context.WINDOW_SERVICE);
        if (wm == null) {
            return ContextHolder.getResource().getDisplayMetrics().heightPixels;
        }
        Point point = new Point();
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            wm.getDefaultDisplay().getRealSize(point);
    ...
    public static float getScreenDensity() {
        return ContextHolder.getResource().getDisplayMetrics().density;
    }
    ...
    public static int getScreenDensityDpi() {
        return ContextHolder.getResource().getDisplayMetrics().densityDpi;
    }
    ...
    public static boolean isLandscape() {
        return ContextHolder.getResource().getConfiguration().orientation
    ...
    public static boolean isScreenLock() {
        KeyguardManager km =
                (KeyguardManager) ContextHolder.getContext().getSystemService(Context.KEYGUARD_SERVICE);
    ...
    public static boolean isTablet() {
        return (ContextHolder.getResource().getConfiguration().screenLayout
