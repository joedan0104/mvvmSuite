        ...
        if (android.os.Build.VERSION.SDK_INT > android.os.Build.VERSION_CODES.LOLLIPOP) {
            ...
            try {// 有"有权查看使用权限的应用"选项
                ApplicationInfo info =
                        packageManager.getApplicationInfo(ContextHolder.getContext().getPackageName(), 0);
                AppOpsManager aom =
                        (AppOpsManager) ContextHolder.getContext().getSystemService(Context.APP_OPS_SERVICE);
                if (aom != null) {
                ...
                UsageStatsManager usageStatsManager = (UsageStatsManager) ContextHolder.getContext()
