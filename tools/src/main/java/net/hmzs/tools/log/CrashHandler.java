...
import net.hmzs.tools.Config;
import net.hmzs.tools.R;
import net.hmzs.tools.utils.ActivityUtils;
import net.hmzs.tools.utils.ContextHolder;
import net.hmzs.tools.utils.DateUtils;
import net.hmzs.tools.utils.PermissionCheck;
...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    private void dumpExceptionToSDCard(Throwable tr) throws IOException {
        ...
        String time = DateUtils.formatter(DateUtils.Format.SECOND, System.currentTimeMillis());
        // 以当前时间创建log文件
