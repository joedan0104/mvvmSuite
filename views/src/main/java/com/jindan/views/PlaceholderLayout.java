...
public class PlaceholderLayout extends FrameLayout {
    ...
    private static String errorStr = "网络不畅";
    private static String networkStr = "无网络连接，";
    private static String reloadBtnStr = "点击刷新";
    private static int emptyImgId = R.drawable.placeholder_empty;
    private static int errorImgId = R.drawable.placeholder_network;
    ...
    private static int buttonTextColor = R.color.placeholder_button_text_color;
    ...
    private static int backgroundColor = R.color.colorGrey;
