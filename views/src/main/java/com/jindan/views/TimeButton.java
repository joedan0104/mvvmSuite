...
public class TimeButton extends NoDoubleClickTextView {
    ...
    private        String            textMiddle = "正在获取";
    /** disable时显示的内容 */
    ...
    public void runTimer() {
        ...
        timer.schedule(timerTask, 0, 1000);
        // timer.scheduleAtFixedRate(task, delay, period);
        this.setTextColor(ContextCompat.getColor(getContext(), R.color.text_silver));
    }

    public void preperTimer() {
        this.setText(textMiddle);
        this.setClickable(false);
        this.setEnabled(false);
        this.setFocusable(false);
        this.setTextColor(ContextCompat.getColor(getContext(), R.color.text_silver));
    ...
    public void reset() {
        ...
        this.setTextColor(ContextCompat.getColor(getContext(), R.color.text_orange_color));
        clearTimer();
        if (null != mCallback) {
            mCallback.reset();
        }
