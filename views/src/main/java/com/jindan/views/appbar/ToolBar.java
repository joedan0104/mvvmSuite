package com.jindan.views.appbar;
...
public class ToolBar extends LinearLayout {
    ...
    public void initView(AttributeSet attrs) {
        ...
        titleBar.setDividerHeight(getContext().getResources().getDimensionPixelSize(R.dimen.app_bar_divider_height));
        titleBar.setTitleSize(ConvertUtils.px2sp(getContext().getResources().getDimension(R.dimen.app_bar_title_size)));
        titleBar.setLeftTextSize(ConvertUtils.px2sp(getContext().getResources().getDimension(R.dimen.app_bar_left_size)));
        titleBar.setRightTextSize(ConvertUtils.px2sp(getContext().getResources().getDimension(R.dimen.app_bar_right_size)));
        ...
        if (typedArray.hasValue(R.styleable.ToolBar_leftSize)) {
            leftSize = typedArray.getDimensionPixelSize(R.styleable.ToolBar_leftSize, ConvertUtils.sp2px(16));
            titleBar.setLeftTextSize(ConvertUtils.px2sp(leftSize));
        }
        ...
        if (typedArray.hasValue(R.styleable.ToolBar_titleSize)) {
            titleSize = typedArray.getDimensionPixelSize(R.styleable.ToolBar_titleSize, ConvertUtils.sp2px(16));
            titleBar.setTitleSize(ConvertUtils.px2sp(titleSize));
        }
        ...
        if (typedArray.hasValue(R.styleable.ToolBar_subTitleSize)) {
            subTitleSize = typedArray.getDimensionPixelSize(R.styleable.ToolBar_subTitleSize, ConvertUtils.sp2px(12));
            titleBar.setSubTitleSize(ConvertUtils.px2sp(subTitleSize));
        }
        ...
        if (typedArray.hasValue(R.styleable.ToolBar_rightSize)) {
            rightSize = typedArray.getDimensionPixelSize(R.styleable.ToolBar_rightSize, ConvertUtils.sp2px(12));
            titleBar.setRightTextSize(ConvertUtils.px2sp(rightSize));
        }
        /**-------------获取divider颜色------------*/
        ...
        if (typedArray.hasValue(R.styleable.ToolBar_bottomDividerHeight)) {
            dividerHeight = typedArray.getDimensionPixelSize(R.styleable.ToolBar_bottomDividerHeight, ConvertUtils.sp2px(1));
            titleBar.setDividerHeight((int) ConvertUtils.px2sp(dividerHeight));
        }
        /**-------------背景颜色------------*/
