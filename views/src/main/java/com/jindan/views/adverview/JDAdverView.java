package com.jindan.views.adverview;
...
import com.jindan.tools.utils.OSUtils;
...
public class JDAdverView extends LinearLayout {
    ...
    private void performSwitch() {
        ...
        if(null == animatorSet) {
            ...
            if(null == mFirstView || null == mSecondView) {
                return;
            }
            ...
            animatorSet.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {//动画结束
                    ...
                    if (null != removedView) {
                        ...
                        if(total > 0) {
                            mAdapter.setItem(removedView, mAdapter.getItem(mPosition % total));
                        }
                        //移除前一个view
                        try{
