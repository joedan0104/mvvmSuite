...
public class JDWebView extends WebView {
    ...
    public JDWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
        intWebView(context);
    }

    public JDWebView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void intWebView(final Context context) {
        ...
        this.setWebViewClient(new JDWebViewClient());
    }
}
