...
import com.jindan.network.utils.SerializedUtil;
...
final class JDRequestBodyConverter<T> implements Converter<T, RequestBody> {
    ...
    public RequestBody convert(T args) throws IOException {
        ...
        Logger.d("way","sendRequest-请求-bodydata=" + builder.toString());
        byte[] bytes;
        if (index >= 0) {
